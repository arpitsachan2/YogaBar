  ...
  return (
    <div id='qq'>
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>Li'l Ones</h1>
        <p className='text-[1vw] '>We took the most nutritious ancient grains and turned them into the most wholesome treats for your li’l ones! Now, that’s ‘babylicious’.</p>
      </div>
        ...
        <div className='w-[100vw] h-[vw] bg-[#182C1D] flex justify-center '>
          ...
          <div className='bg-[#182C1D] h-[40vw] w-[87vw]   '>
            ...
            >
              <div  >
                <SwiperSlide  >
                  <video controls src='https://cdn.shopify.com/videos/c/o/v/7efb7b18b8fb453a8217dd4495cd58c7.mp4' className='size-[32vw] ' ></video>
                ...
                <SwiperSlide>
                  <video controls src='https://cdn.shopify.com/videos/c/o/v/5d65f51fe45e4321a8ccbaf854a922f7.mp4' className='size-[32vw]'></video>
                  <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                  <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
                    Did you know maida is also called 'white poison'?</h3>
                </SwiperSlide>
                <SwiperSlide>
                  <video controls src='https://cdn.shopify.com/videos/c/o/v/877c4ab4ce51452db65a586c1ac774c6.mp4' className='size-[32vw]'></video>
                  <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                  <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
