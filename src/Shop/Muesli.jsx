  ...
  return (
   <div id='qq'>
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>Muesli</h1>
        <p className='text-[1vw] '>Don’t be silly! What’s not to love about these Mueslis? Packed with a lot more nuts, berries and seeds, a bowlful of any of these will surely satisfy all your breakfast needs.</p>
      </div>
      ...
      <div className='w-[100vw] h-[vw] bg-[#182C1D] flex justify-center '>
        ...
        <div className='bg-[#182C1D] h-[40vw] w-[87vw]   '>
          ...
          >
            <div  >
              <SwiperSlide  >
                <video  controls src='https://cdn.shopify.com/videos/c/o/v/2169242e2ac448e9a0f13455f08c0537.mp4' className='size-[36vw] ' ></video>
              ...
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/f87152c52b314716bf175b04f8a886e5.mp4' className='size-[36vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
                  Did you know maida is also called 'white poison'?</h3>
              </SwiperSlide>
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/c07d6b33c62b433dbb31ee7e162e8b65.mp4' className='size-[36vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
                  Your protein needs depend on your lifestyle.</h3>
              </SwiperSlide>
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/7ef7b6b0a08d4b7b892c3e3283257c76.mp4' className='size-[36vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
