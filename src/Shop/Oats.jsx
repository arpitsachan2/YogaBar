...
const Oats = () => {
  return (
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>Oats & Quinoa</h1>
        <p className='text-[1vw] '>When it comes to our range of oats, we can’t help but gloat. Chocolatey, nutty, spicy, whole-grainy, it’s simply delightful! No wonder you keep coming back for more.</p>
      </div>
      ...
      <div className='w-[100vw] h-[vw] bg-[#182C1D] flex justify-center '>
        ...
        <div className='bg-[#182C1D] h-[40vw] w-[87vw]   '>
          ...
          >
            <div  >
              <SwiperSlide  >
                <video controls src='https://cdn.shopify.com/videos/c/o/v/2269d343ab9b41548159b1cb92a81a7b.mp4' className='size-[32vw] ' ></video>
              ...
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/994c4def98584b2eaf02c9c4c4ecf39a.mp4' className='size-[32vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
                  Did you know maida is also called 'white poison'?</h3>
              </SwiperSlide>
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/76eada7b63304816b11dcc494dcee6a9.mp4' className='size-[32vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
                  Your protein needs depend on your lifestyle.</h3>
              </SwiperSlide>
              <SwiperSlide>
                <video controls src='https://cdn.shopify.com/videos/c/o/v/36d5952964394e4787176281141e28d9.mp4' className='size-[32vw]'></video>
                <img src={yellow} alt="" className='absolute -mt-[7.5vw]' />
                <h3 className=' text-[1.5vw] text-gray-800 font-bold absolute -mt-[4.5vw] text-center ' >
