  ...
  return (
    <div>
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>Bars</h1>
        <p className='text-[1vw] '>Bars so good you’ll be reaching for it bar, bar. Balanced, wholesome, and made with the cleanest ingredients – they're (probably) the most advanced bars in town!</p>
      </div>
