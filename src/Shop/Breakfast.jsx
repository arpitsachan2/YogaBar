  ...
  return (
    <div id='qq'>
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>Breakfast</h1>
        <p className='text-[1vw] '>Something corny. Something chocolatey. All things crunchy. Just so you can start your mornings on the right note.</p>
      </div>
