...
const New = () => {
  ...
  <div id='qq'>
      ...
      <div className='w-[100vw] h-[13vw]  text-center border-b-[0.15vw] border-gray-400 ' >
        <h1 id='paytone' className='text-[6vw] '>New Launches & Offers</h1>
        <p className='text-[1vw] '>Let’s put a smile on that face! Explore our new launches and delightful offers.</p>
      </div>
